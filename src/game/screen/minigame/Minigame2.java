...
public class Minigame2 extends Knoten {
    ...
    private void InitImgs(){
        ...
        for(int i = 0; i< tileCount; i++){
            ...
            try {
                ...
                System.out.println("game.screen.minigame.Minigame2: "  + e);
            }
        }
        ...
        if(active && rolling){
            switch(rowPos){
                case(0):
                    ...
                    for(int i = 0; i< tileCount; i++){
                        ...
                        //System.out.println("game.screen.minigame.Minigame2: Row0 wird nach unten verschoben");
            ...
            if(speed <= 0){
                if(rowPos >= 2){ //falls noch nicht reihe 2 fdann eine reihe weiter mit speed = 10;
                    System.out.println("game.screen.minigame.Minigame2: " + rowPos + " ist jz unten angekommen");
                    //Game zu ende
                    rolling = false;
    ...
    private int analyseJackpot(){
        ...
        for(int i = 0;i<check;i++){
            ...
            System.out.println("game.screen.minigame.Minigame2: Testet Reihe mit i(" + i+ "), welche eig. Reihe " + pos + " ist.");
