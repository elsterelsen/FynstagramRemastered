...
class ImageCollider extends Knoten {
    ...
    private int PlayerW = 30;//originally 48
    private int PlayerH = 5;//originally 85?
    ...
    public ImageCollider(String path){
        ...
        try{
            ...
            System.out.println("Fehler in der game.map_collision.ImageCollider Klasse: Bild bei " + ImgPath + " kann nicht gefunden werden!");
    ...
    public boolean TestColl(int ObjectX, int ObjectY){
        ...
        for(int i=0;i<PlayerH;i++){ //links nach unten
            ...
            try{
                ...
                //System.out.println(e);
                //System.out.println("Fehler in der game.map_collision.ImageCollider Klasse: Spieler ist nicht in der Fläche eines Kolliders");
            }
           int r = (p>>16) & 0xff;
           if(r<100){
               coll = true;
    ...
    public int getWalkColor(DummyPlayer dp){
        int x = (int)dp.getX();
        int y = (int)dp.getY();
        System.out.println("Reelle pos ist: " + x +"," + y);
    ...
    public ColliderReturnType scanSurrounding(DummyPlayer dp){
        ...
        playerX = playerX - offsetX+9;
        playerY = playerY -offsetY + 80;
        //System.out.println("Sucht von LO Corr: " + ObjectX + ", " + ObjectY);
