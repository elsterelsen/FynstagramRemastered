...
public class SoundController {
    ...
    public void tickMusic() {
        ...
        if (tickCounter >= pauseLength) {
            tickCounter = 0;
            System.out.println("game.sound.SoundController: Neue Music wird angefangen!");
            stopAllMusic();
            playRandomSound();
        }
    }
    ...
    public void toggleMute() {
        if (mute) {
            mute = false;
            System.out.println("game.sound.SoundController: Game wurde entmutet");
            playRandomSound();

        } else {
            System.out.println("game.sound.SoundController: Game wurde gemutet");
            mute = true;
            stopAllMusic();
        }
    }
